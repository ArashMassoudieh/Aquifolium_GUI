...
public:
    ...
    {
        gridWindow->setWindowTitle(QApplication::translate("gridWindow", "Array configuration dialog", nullptr));
        groupBoxV->setTitle(QApplication::translate("gridWindow", "2D Vertical array configuration", nullptr));
        label_4->setText(QApplication::translate("gridWindow", "Number of rows", nullptr));
        label_5->setText(QApplication::translate("gridWindow", "Number of columns", nullptr));
        heightLbl->setText(QApplication::translate("gridWindow", "Height of blocks: ", nullptr));
        z0Lbl->setText(QApplication::translate("gridWindow", "Bottom elevation of starting block:", nullptr));
        label_1->setText(QApplication::translate("gridWindow", "Total bottom elevation change in horizontal direction", nullptr));
        Label_2->setText(QApplication::translate("gridWindow", "Total bottom elevation change in vertical direction", nullptr));
        lengthUnitBox->setText(QString());
        label_2->setText(QApplication::translate("gridWindow", "Horizontal distance between cell grids", nullptr));
        label_r0->setText(QApplication::translate("gridWindow", "r0", nullptr));
        r0UnitBox->setText(QString());
        radioButtonV->setText(QApplication::translate("gridWindow", "Vertical 2D array", nullptr));
        radioButtonH->setText(QApplication::translate("gridWindow", "Horizontal 2D array", nullptr));
        radioButtonR->setText(QApplication::translate("gridWindow", "Radially symmetrical array", nullptr));
        groupBoxH->setTitle(QApplication::translate("gridWindow", "2D Horizontal array configuration", nullptr));
        label_9->setText(QApplication::translate("gridWindow", "Number of rows", nullptr));
        label_10->setText(QApplication::translate("gridWindow", "Number of columns", nullptr));
        z0Lbl_3->setText(QApplication::translate("gridWindow", "Bottom elevation of starting block:", nullptr));
        label_11->setText(QApplication::translate("gridWindow", "Total bottom elevation change in x direction", nullptr));
        Label_4->setText(QApplication::translate("gridWindow", "Total bottom elevation change in y direction", nullptr));
        lengthXUnitBox->setText(QString());
        label_12->setText(QApplication::translate("gridWindow", "Horizontal distance between cell in x direction", nullptr));
        label_13->setText(QApplication::translate("gridWindow", "Horizontal distance between cell in y direction", nullptr));
