...
public:
    ...
    QPushButton *btnHide;
    QPushButton *btnStop;
    QPushButton *btnSolutionDetails;
    ...
    void setupUi(QMainWindow *runtimeWindow)
    {
        ...
        btnSolutionDetails = new QPushButton(centralWidget);
        btnSolutionDetails->setObjectName(QStringLiteral("btnSolutionDetails"));
        sizePolicy3.setHeightForWidth(btnSolutionDetails->sizePolicy().hasHeightForWidth());
        btnSolutionDetails->setSizePolicy(sizePolicy3);

        verticalLayout->addWidget(btnSolutionDetails);
    ...
    {
        runtimeWindow->setWindowTitle(QApplication::translate("runtimeWindow", "Simulation Status", nullptr));
        topLabel->setText(QString());
        label->setText(QApplication::translate("runtimeWindow", "Epoch count", nullptr));
        btnHide->setText(QApplication::translate("runtimeWindow", "Hide", nullptr));
        btnStop->setText(QApplication::translate("runtimeWindow", "Stop running", nullptr));
        btnSolutionDetails->setText(QApplication::translate("runtimeWindow", "Show Solution Details", nullptr));
        refreshPlot->setText(QApplication::translate("runtimeWindow", "Refresh graph \n"
"at each time step", nullptr));
    } // retranslateUi
